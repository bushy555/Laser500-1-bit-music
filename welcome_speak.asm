...
speak	
	ld a,$8		;revert potential code modification
	ld (sval),a
...
waitlp	push hl
sval EQU $+1
		ld l,$7		;self-modifying speed adjustment
ilp		dec l
		jr nz,ilp
...
msg0	db	"    WELCOME TO THE LAZER FIVE HUNDRED. ",0

msg1	db 8,"welkum{{",12,"tuu{",12,"{ja{"
	db 14,"lazja{{",12,"five{{",15,"hundred{{",15,00

msg2	db	"    PLEASE PRESS THE <SPACE> BAR. ",0

msg3

	db "{pleez",18,"{press",19,"{ja{",22
	db "spac{",20,"baar",22
	db $14, 00
