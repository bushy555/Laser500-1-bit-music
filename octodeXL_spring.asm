; Night Dancer - Mr Beep.
; For the Laser500.
; Ported by bushy. Aug 24.
;
; --------------------------

;Add an execution basic 'RUN' header:
	output "spring.bin"	; USE this if assembling with SJASM.  Else, comment out for PASMO/TASM.
...
.lb7
		...
		sbc a
		nop
		and 1; 64;32;16			; 4+4+4 + 4+4+7=27t
